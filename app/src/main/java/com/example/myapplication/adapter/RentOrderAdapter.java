...
public class RentOrderAdapter extends RecyclerView.Adapter<RentOrderAdapter.ViewHolder> {
    private List<Order> rowData;
    Context context;
    private final FirebaseFirestore db = FirebaseFirestore.getInstance();
    private final FirebaseAuth mAuth = FirebaseAuth.getInstance();

    public RentOrderAdapter(Context context, List<Order> data) {
        rowData = data;
        context = context;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            textOrderTime = (TextView) itemView.findViewById(R.id.textOrderTime);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rent_parking_lot_order_list, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.textOrderTime.setText("訂單時間：" + rowData.get(position).getTimestamp());
    }
